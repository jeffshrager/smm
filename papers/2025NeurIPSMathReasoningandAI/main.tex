...
\begin{itemize}
  \item \textbf{Counting-Addition Conflict:} The model initially overgeneralizes successor relationships (e.g., learning ``$2\to3$'' before ``$2+3=5$''), mirroring children's early developmental errors.
...
\section{Next Steps (To be updated)}
